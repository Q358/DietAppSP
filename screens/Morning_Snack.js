...
export default function Morning_Snack({ navigation }) {
  ...
  return (
    <View style={{...styles.container}}>
      <Text style = {{marginTop: 45, textAlign: "center", marginLeft: 15, color:'white', fontFamily:'fontBold', fontSize:30}}>Today's Morning Snack</Text>
