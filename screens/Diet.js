...
export default function Diet({ navigation }) {
  return (
    <View style={{...styles.container, alignItems: "center"}}>
      ...
      <Text style = {{fontFamily: "fontBold", color:"white", fontSize:35, marginTop:-15, marginBottom: 10}}>Today's Meals</Text>
      ...
      <Text style = {{fontFamily: "fontBold", color:"white", fontSize:35, marginTop:-25, marginBottom: 10}}>This Week</Text>
      <View style = {{...styles.rectangle2, marginTop: 10, marginRight:250}}>
        <Text style = {{marginTop:20, marginLeft: 135, color:"black", fontSize:10}}>Sunday</Text>
